...
— Simulation-Extrapolation (SIMEX / MC-SIMEX) with a formula interface:
...
(Battaglia, Christensen, Hansen & Sacher, 2025):
...
[`mcglm()`](https://ojalab.github.io/mismeasured/reference/mcglm.md)
returns asymptotic standard errors for every fitted method (sandwich
estimators from Battaglia et al., 2025). All the usual GLM S3 methods
are available; pass `method =` to select an estimator.
